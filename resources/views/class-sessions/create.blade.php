<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Crear Nueva Sesión') }} - {{ $activity->nombre }}
        </h2>
    </x-slot>
                    ...
                    <form action="{{ route('class-sessions.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <select id="dia_semana" name="dia_semana"
                                    ...
                                    @foreach ($diasSemana as $dia)
                                        <option value="{{ $dia }}"
                                            {{ old('dia_semana') == $dia ? 'selected' : '' }}>{{ $dia }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="hora_inicio" type="time" name="hora_inicio" :value="old('hora_inicio')"
                            ...
                            <div>
                                ...
                                <x-text-input id="hora_fin" type="time" name="hora_fin" :value="old('hora_fin')"
                                    class="mt-1 block w-full" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="sala" type="text" name="sala" :value="old('sala')"
                                    class="mt-1 block w-full" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="capacidad_max" type="number" min="1" name="capacidad_max"
                                    :value="old('capacidad_max')" class="mt-1 block w-full" required />
