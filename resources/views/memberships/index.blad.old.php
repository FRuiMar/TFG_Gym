            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-2xl font-bold">Membresías Registradas</h1>
                    ...
                    @if ($memberships->isEmpty())
                        <div class="text-center py-8">
                            <p class="text-gray-500 dark:text-gray-400">No hay membresías registradas.</p>
                        </div>
                    @else
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900 dark:text-white">
                                                    @if ($membership->type === 'Sin membresía')
                                                        <span
                                                            class="text-gray-500 dark:text-gray-400">{{ $membership->type }}</span>
                                                    @else
                                                        {{ $membership->type }}
                                                    @endif
                                                </div>
                                                ...
                                                <div class="flex space-x-2">
                                                    ...
                                                    <form action="{{ route('memberships.destroy', $membership) }}"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            onclick="return confirm('¿Estás seguro de querer eliminar esta membresía?');"
                                                            @if ($membership->type === 'Sin membresía') disabled @endif>
                                                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path fill-rule="evenodd"
